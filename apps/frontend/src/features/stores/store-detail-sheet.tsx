...
const StoreDetailSheet = forwardRef<HTMLDivElement, StoreDetailSheetProps>(({ store, onClose }, ref) => {
    ...
    return (
        <div className="fixed bottom-0 left-1/2 z-50 w-full max-w-[var(--app-max-width)] -translate-x-1/2">
            <div
                ref={ref}
                className="w-full p-6 pb-[var(--page-safe-bottom)] glass-panel-strong rounded-t-[28px] shadow-[0_-12px_40px_rgba(15,23,42,0.12)] animate-fade-up"
            >
                <div
